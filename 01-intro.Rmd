...
* `library("...")` is like you are stusing your screwdriver.
...
There is a package `readxl` that allow to open and save `.xsl` and `.xslx` files. Install and load the package:
...
Thent will be possible to create a new file: `File > New File > R Markdown...`.
