...
The `udpipe` package give you an ability to get lemmatisation, morphological and syntactic analysis for multiple languages. Tutorial and list of availible languages can be found [here](https://bnosac.github.io/udpipe/docs/doc1.html).
